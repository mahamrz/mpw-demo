...
```{admonition} Question
:class: question
Have you ever heard a song sampled in another song? Identify one example and explain how the sample was used.
```
...
## In-class demos:
1. **Demo 1 — Create a sampler instrument**:
